...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/Hello_Basys3/Hello_Basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hellobasys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hellobasys3.tcl -notrace
