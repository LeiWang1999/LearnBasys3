...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/Hello_Basys3/Hello_Basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hellobasys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hellobasys3.tcl
