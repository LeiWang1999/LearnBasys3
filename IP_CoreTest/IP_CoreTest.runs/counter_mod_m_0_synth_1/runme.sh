...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/IP_CoreTest/IP_CoreTest.runs/counter_mod_m_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_mod_m_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_mod_m_0.tcl
