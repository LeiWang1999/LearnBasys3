...
#
# Generated by export_simulation on Wed Jan 23 12:50:24 CST 2019
#
################################################################################
...
'-reset_run' switch to the './counter_mod_m_0.sh' script.

./counter_mod_m_0.sh -reset_run
...
./counter_mod_m_0.sh -noclean_files

For more information on the script, please type './counter_mod_m_0.sh -help'.
