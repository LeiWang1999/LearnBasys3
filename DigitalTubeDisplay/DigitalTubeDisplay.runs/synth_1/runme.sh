...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/DigitalTubeDisplay/DigitalTubeDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalTubeDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DigitalTubeDisplay.tcl
