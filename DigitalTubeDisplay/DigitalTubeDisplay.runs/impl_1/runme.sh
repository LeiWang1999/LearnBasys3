...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/DigitalTubeDisplay/DigitalTubeDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DigitalTubeDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DigitalTubeDisplay.tcl -notrace
