...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/WaterlightLed/WaterlightLed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WaterlightLed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WaterlightLed.tcl
