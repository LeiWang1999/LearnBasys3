...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/WaterlightLed/WaterlightLed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WaterlightLed.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WaterlightLed.tcl -notrace
