...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/LearnIP_Core/LearnIP_Core.runs/bin2grey_four_2_input_xor_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bin2grey_four_2_input_xor_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bin2grey_four_2_input_xor_gate_0_0.tcl
