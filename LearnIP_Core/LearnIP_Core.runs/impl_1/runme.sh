...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/LearnIP_Core/LearnIP_Core.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_2_input_nand_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_2_input_nand_gate.tcl -notrace
