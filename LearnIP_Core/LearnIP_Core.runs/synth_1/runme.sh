...
HD_PWD='/home/princeling/Documents/ElectronicDesign/Fpga-verilog/LearnBasys3/LearnIP_Core/LearnIP_Core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_2_input_nand_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_2_input_nand_gate.tcl
